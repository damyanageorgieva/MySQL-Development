/*join tables using SQL to combine datasets*/

/*creating three tables and insert into data*/
...
/* Challenge: Combine two tables together */
SELECT * FROM magpie_attacks UNION SELECT * FROM dropbear_attacks;
SELECT state_code, state_name FROM magpie_attacks UNION SELECT state_code, state_name FROM dropbear_attacks;
SELECT state_code,state_name FROM magpie_attacks UNION ALL SELECT state_code, state_name FROM dropbear_attacks;

/*Difference between inner and outer joins in SQL*/
SELECT 
...
FROM
    magpie_attacks INNER JOIN dropbear_attacks ON
...
SELECT 
    ...
    dropbear_attacks.number_of_attacks AS dropbear_attacks
FROM
    magpie_attacks LEFT OUTER JOIN dropbear_attacks ON
    magpie_attacks.state_code = dropbear_attacks.state_code;
...
SELECT 
    ...
    magpie_attacks.number_of_attacks AS magpie_attacks,
    dropbear_attacks.number_of_attacks AS dropbear_attacks
FROM magpie_attacks RIGHT OUTER JOIN dropbear_attacks ON
    magpie_attacks.state_code = dropbear_attacks.state_code;

/*% of total 'dropbear_attacks' by 'state_code'*/
SELECT 
    magpie_attacks.state_code, 
    magpie_attacks.number_of_attacks AS magpie_attacks,
    dropbear_attacks.number_of_attacks AS dropbear_attacks,
...
FROM magpie_attacks INNER JOIN dropbear_attacks ON
    magpie_attacks.state_code = dropbear_attacks.state_code;
